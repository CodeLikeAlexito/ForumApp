    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    replay_id = table.Column<int>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    replay_description = table.Column<string>(nullable: true),
                    comment_id = table.Column<int>(nullable: false),
                    date_created = table.Column<DateTime>(nullable: false),
                    date_modified = table.Column<DateTime>(nullable: false),
                    user_id = table.Column<string>(nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Replay", x => x.replay_id);
                    table.ForeignKey(
                        name: "FK_Replay_Comment_comment_id",
